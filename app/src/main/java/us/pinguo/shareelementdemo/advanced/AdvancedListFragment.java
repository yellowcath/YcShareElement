...
public class AdvancedListFragment extends Fragment implements BaseListCell.OnCellClickListener, IShareElements {
    ...
    private void initCells() {
        ...
        mDataList.add(new Image("https://phototask.c360dn.com/Fl-0qph8x14uLb2JwRzko8fOmfqw", 1024, 738).setShowInFresco(true));
        mDataList.add(new Image("https://phototask.c360dn.com/FuOUEYx1YLf9gUAykzueD9TzX8Lq", 1280, 800));
