...
public class GlideBitmapSizeCalculator implements IBitmapSizeCalculator {
    ...
    @Override
    public BitmapInfo calculateImageSize(Rect bounds, ImageView.ScaleType scaleType, int sourceWidth, int sourceHeight) {
...
//        }
        ...
        return new BitmapInfo(outWidth,outHeight,exactScaleFactor);
    }
